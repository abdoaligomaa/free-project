            ...
            <TBody>
              <TR>
                <TD style={textStyle}>
                  ...
                  <EmptySpace height={20} />
                  <div>
                    We regret to inform you that your host {hostName} has
                    cancelled your reservation {confirmationCode} at {listTitle}{' '}
                    {isPastDay ? 'started' : 'starting'} on {checkInDate}.
                    {refundToGuest > 0 && (
                      <span>
                        {' '}
                        As per the cancellation policy you will be refunded{' '}
                        <CurrencyView
