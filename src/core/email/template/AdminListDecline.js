...
class AdminListDecline extends React.Component {
  ...
  render() {
    ...
    const {
      content: { hostName, listId, listTitle, logo, reason },
    } = this.props;
    ...
    return (
      <Layout>
        ...
        <Body textStyle={textStyle}>
          ...
          <div>
            Admin has declined your listing request for the {listTitle} due to
            the reason of {reason}. Kindly update the listing information and
            submit for the list approval.
          </div>
