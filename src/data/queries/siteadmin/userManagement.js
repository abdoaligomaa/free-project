...
const userManagement = {
  ...
  async resolve(source, { currentPage, searchList, userType }, { request, response } , cccc) {
          ...
          id: {
            $or: [
              ...
              },
              {
                $in: [
                  sequelize.literal(
                    `SELECT userId FROM UserProfile WHERE lastName like '%${searchList}%'`,
                  ),
                ],
              },
              {
                $in: [
                  sequelize.literal(
                    `SELECT userId FROM UserProfile WHERE phoneNumber like '%${searchList}%'`,
                  ),
                ],
              },
              {
