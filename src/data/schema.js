...
import editListingAccepted from './queries/editListingAccepted';
import editListingReviewed from './queries/EditListingReviewed';
...
import getSiteAdminRecommended from './queries/getSiteAdminRecommended';
import getRecommend from './queries/getRecommend';
import getHasSharingNow from './queries/getHasSharingNow';
...
import checkReservationExists from './queries/Reservation/checkReservationExists';
...
// Split And Share
import acceptSubguest from './mutations/SplitAndShare/acceptSubguest';
import cancelSubguest from './mutations/SplitAndShare/cancelSubguest';
...
import updateSiteAdminRecommended from './mutations/SiteAdmin/updateSiteAdminRecommended';
...
import GetAllSubguestDetail from './queries/GetAllSubguestDetail';
import cancelReservtionMutation from './mutations/cancelReservtionMutation';

import createRepost from './mutations/createRepost';
import updateRepost from './mutations/updateRepost';
import createNewSubgust from './mutations/createNewSubgust';

import createSwap from './mutations/createSwap';
import updateSwap from './mutations/updateSwap';

import getAllSwapListForCurrentUser from './queries/Listing/getAllSwapListForCurrentUser';

import getSwaps from './queries/getSwaps';
import getReposts from './queries/getReposts';
import getHostReposts from './queries/getHostReposts';
import getListingRepostsAndSwaps from './queries/getListingRepostsAndSwaps';

import cancelSubguestReservation from './mutations/cancelSubguestReservation';

import createRepostFixedPrice from './mutations/createRepostFixedPrice';

//coupons
//mutations
import createCoupon from './mutations/SiteAdmin/Coupon/createCoupon';
import updateCoupon from './mutations/SiteAdmin/Coupon/updateCoupon';
import deleteCoupon from './mutations/SiteAdmin/Coupon/deleteCoupon';
//queries
import getAllCoupons from './queries/siteadmin/Coupon/getAllCoupons';
import getAllUserCoupons from './queries/Coupon/getAllUserCoupons';
import getCoupon from './queries/siteadmin/Coupon/getCoupon';
import checkCoupon from './queries/siteadmin/Coupon/checkCoupon';
...
const schema = new Schema({
  query: new ObjectType({
    ...
    fields: {
      ...
      getSiteSettingsLogo,
      GetAllSubguestDetail,
      getAllSwapListForCurrentUser,
      getSwaps,
      getAllCoupons,
      getCoupon,
      checkCoupon,
  ...
  mutation: new ObjectType({
    ...
    fields: {
      ...
      removeFavIconLogo,
      cancelReservtionMutation,
      createRepost,
      updateRepost,
      createSwap,
      updateSwap,
      cancelSubguestReservation,
      createRepostFixedPrice,
      createNewSubgust,
      createCoupon,
      updateCoupon,
      deleteCoupon,
