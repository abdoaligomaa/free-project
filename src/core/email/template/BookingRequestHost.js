...
class BookingRequestHost extends React.Component {
  ...
  render() {
    ...
    const {
      content: { listTitle, basePrice, total, hostServiceFee, currency },
    } = this.props;
            ...
            <TBody>
              <TR>
                <TD style={textStyle}>
                  ...
                  <div>
                    {guestName} would stay in the {listTitle} from {checkInDate}{' '}
                    to {checkOutDate}.
                  </div>
                  <EmptySpace height={10} />
                  <div>
                    ...
                    night with the associated cost, your estimated payment for
                    this booking is{' '}
