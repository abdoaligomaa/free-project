...
const updateWhyHostPage = {
  ...
  async resolve(source,{
    ...
    if (request.user && request.user.admin == true) {
      ...
      if (hostBannerTitle1) {
        const updatehostBannerTitle1 = await WhyHostInfoBlock.update(
          { value: hostBannerTitle1 },
          { where: { name: 'hostBannerTitle1' } },
      ...
      if (hostBannerImage1) {
        const updatehostBannerImage1 = await WhyHostInfoBlock.update(
          { value: hostBannerImage1 },
          { where: { name: 'hostBannerImage1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (whyBlockTitle1) {
        const updatewhyBlockTitle1 = await WhyHostInfoBlock.update(
          { value: whyBlockTitle1 },
          { where: { name: 'whyBlockTitle1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (whyBlockContent1) {
        const updatewhyBlockContent1 = await WhyHostInfoBlock.update(
          { value: whyBlockContent1 },
          { where: { name: 'whyBlockContent1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (whyBlockTitle2) {
        const updatewhyBlockTitle2 = await WhyHostInfoBlock.update(
          { value: whyBlockTitle2 },
          { where: { name: 'whyBlockTitle2' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (whyBlockContent2) {
        const updatewhyBlockContent2 = await WhyHostInfoBlock.update(
          { value: whyBlockContent2 },
          { where: { name: 'whyBlockContent2' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (hostingBlockTitleHeading) {
        const updatehostingBlockTitleHeading = await WhyHostInfoBlock.update(
          { value: hostingBlockTitleHeading },
          { where: { name: 'hostingBlockTitleHeading' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (hostingBlockTitle1) {
        const updatehostingBlockTitle1 = await WhyHostInfoBlock.update(
          { value: hostingBlockTitle1 },
          { where: { name: 'hostingBlockTitle1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (hostingBlockTitle2) {
        const updatehostingBlockTitle2 = await WhyHostInfoBlock.update(
          { value: hostingBlockTitle2 },
          { where: { name: 'hostingBlockTitle2' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (hostingBlockTitle3) {
        const updatehostingBlockTitle3 = await WhyHostInfoBlock.update(
          { value: hostingBlockTitle3 },
          { where: { name: 'hostingBlockTitle3' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (hostingBlockContent1) {
        const updatehostingBlockContent1 = await WhyHostInfoBlock.update(
          { value: hostingBlockContent1 },
          { where: { name: 'hostingBlockContent1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (hostingBlockContent2) {
        const updatehostingBlockContent2 = await WhyHostInfoBlock.update(
          { value: hostingBlockContent2 },
          { where: { name: 'hostingBlockContent2' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (hostingBlockContent3) {
        const updatehostingBlockContent3 = await WhyHostInfoBlock.update(
          { value: hostingBlockContent3 },
          { where: { name: 'hostingBlockContent3' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (paymentTitleHeading) {
        const updatepaymentTitleHeading = await WhyHostInfoBlock.update(
          { value: paymentTitleHeading },
          { where: { name: 'paymentTitleHeading' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (paymentTitle1) {
        const updatepaymentTitle1 = await WhyHostInfoBlock.update(
          { value: paymentTitle1 },
          { where: { name: 'paymentTitle1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (paymentTitle2) {
        const updatepaymentTitle2 = await WhyHostInfoBlock.update(
          { value: paymentTitle2 },
          { where: { name: 'paymentTitle2' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (paymentTitle3) {
        const updatepaymentTitle3 = await WhyHostInfoBlock.update(
          { value: paymentTitle3 },
          { where: { name: 'paymentTitle3' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (paymentContent1) {
        const updatepaymentContent1 = await WhyHostInfoBlock.update(
          { value: paymentContent1 },
          { where: { name: 'paymentContent1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (paymentContent2) {
        const updatepaymentContent2 = await WhyHostInfoBlock.update(
          { value: paymentContent2 },
          { where: { name: 'paymentContent2' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (paymentContent3) {
        const updatepaymentContent3 = await WhyHostInfoBlock.update(
          { value: paymentContent3 },
          { where: { name: 'paymentContent3' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (coverSectionTitle1) {
        const updatecoverSectionTitle1 = await WhyHostInfoBlock.update(
          { value: coverSectionTitle1 },
          { where: { name: 'coverSectionTitle1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (coverSectionImage1) {
        const updatecoverSectionImage1 = await WhyHostInfoBlock.update(
          { value: coverSectionImage1 },
          { where: { name: 'coverSectionImage1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (coverSectionContent1) {
        const updatecoverSectionContent1 = await WhyHostInfoBlock.update(
          { value: coverSectionContent1 },
          { where: { name: 'coverSectionContent1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (coverSectionContent2) {
        const updatecoverSectionContent2 = await WhyHostInfoBlock.update(
          { value: coverSectionContent2 },
          { where: { name: 'coverSectionContent2' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (coverSectionFeature1) {
        const updatecoverSectionFeature1 = await WhyHostInfoBlock.update(
          { value: coverSectionFeature1 },
          { where: { name: 'coverSectionFeature1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (coverSectionFeature2) {
        const updatecoverSectionFeature2 = await WhyHostInfoBlock.update(
          { value: coverSectionFeature2 },
          { where: { name: 'coverSectionFeature2' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (coverSectionFeature3) {
        const updatecoverSectionFeature3 = await WhyHostInfoBlock.update(
          { value: coverSectionFeature3 },
          { where: { name: 'coverSectionFeature3' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (coverSectionFeature4) {
        const updatecoverSectionFeature4 = await WhyHostInfoBlock.update(
          { value: coverSectionFeature4 },
          { where: { name: 'coverSectionFeature4' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (coverSectionFeature5) {
        const updatecoverSectionFeature5 = await WhyHostInfoBlock.update(
          { value: coverSectionFeature5 },
          { where: { name: 'coverSectionFeature5' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (coverSectionFeature6) {
        const updatecoverSectionFeature6 = await WhyHostInfoBlock.update(
          { value: coverSectionFeature6 },
          { where: { name: 'coverSectionFeature6' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (quoteSectionTitle1) {
        const updatequoteSectionTitle1 = await WhyHostInfoBlock.update(
          { value: quoteSectionTitle1 },
          { where: { name: 'quoteSectionTitle1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (quoteSectionTitle2) {
        const updatequoteSectionTitle2 = await WhyHostInfoBlock.update(
          { value: quoteSectionTitle2 },
          { where: { name: 'quoteSectionTitle2' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (quoteSectionContent1) {
        const updatequoteSectionContent1 = await WhyHostInfoBlock.update(
          { value: quoteSectionContent1 },
          { where: { name: 'quoteSectionContent1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (quoteSectionContent2) {
        const updatequoteSectionContent2 = await WhyHostInfoBlock.update(
          { value: quoteSectionContent2 },
          { where: { name: 'quoteSectionContent2' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (quoteSectionImage1) {
        const updatequoteSectionImage1 = await WhyHostInfoBlock.update(
          { value: quoteSectionImage1 },
          { where: { name: 'quoteSectionImage1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (quoteSectionImage2) {
        const updatequoteSectionImage2 = await WhyHostInfoBlock.update(
          { value: quoteSectionImage2 },
          { where: { name: 'quoteSectionImage2' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (quoteSectionButton1) {
        const updatequoteSectionButton1 = await WhyHostInfoBlock.update(
          { value: quoteSectionButton1 },
          { where: { name: 'quoteSectionButton1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (quoteSectionButton2) {
        const updatequoteSectionButton2 = await WhyHostInfoBlock.update(
          { value: quoteSectionButton2 },
          { where: { name: 'quoteSectionButton2' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqTitle1 || faqTitle1 == '') {
        const updatefaqTitle1 = await WhyHostInfoBlock.update(
          { value: faqTitle1 },
          { where: { name: 'faqTitle1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqTitle2 || faqTitle2 == '') {
        const updatefaqTitle2 = await WhyHostInfoBlock.update(
          { value: faqTitle2 },
          { where: { name: 'faqTitle2' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqTitle3 || faqTitle3 == '') {
        const updatefaqTitle3 = await WhyHostInfoBlock.update(
          { value: faqTitle3 },
          { where: { name: 'faqTitle3' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqTitle4 || faqTitle4 == '') {
        const updatefaqTitle4 = await WhyHostInfoBlock.update(
          { value: faqTitle4 },
          { where: { name: 'faqTitle4' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqTitle5 || faqTitle5 == '') {
        const updatefaqTitle5 = await WhyHostInfoBlock.update(
          { value: faqTitle5 },
          { where: { name: 'faqTitle5' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqTitle6 || faqTitle6 == '') {
        const updatefaqTitle6 = await WhyHostInfoBlock.update(
          { value: faqTitle6 },
          { where: { name: 'faqTitle6' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqTitle7 || faqTitle7 == '') {
        const updatefaqTitle7 = await WhyHostInfoBlock.update(
          { value: faqTitle7 },
          { where: { name: 'faqTitle7' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqTitle8 || faqTitle8 == '') {
        const updatefaqTitle8 = await WhyHostInfoBlock.update(
          { value: faqTitle8 },
          { where: { name: 'faqTitle8' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqContent1 || faqContent1 == '') {
        const updatefaqContent1 = await WhyHostInfoBlock.update(
          { value: faqContent1 },
          { where: { name: 'faqContent1' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqContent2 || faqContent2 == '') {
        const updatefaqContent2 = await WhyHostInfoBlock.update(
          { value: faqContent2 },
          { where: { name: 'faqContent2' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqContent3 || faqContent3 == '') {
        const updatefaqContent3 = await WhyHostInfoBlock.update(
          { value: faqContent3 },
          { where: { name: 'faqContent3' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqContent4 || faqContent4 == '') {
        const updatefaqContent4 = await WhyHostInfoBlock.update(
          { value: faqContent4 },
          { where: { name: 'faqContent4' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqContent5 || faqContent5 == '') {
        const updatefaqContent5 = await WhyHostInfoBlock.update(
          { value: faqContent5 },
          { where: { name: 'faqContent5' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqContent6 || faqContent6 == '') {
        const updatefaqContent6 = await WhyHostInfoBlock.update(
          { value: faqContent6 },
          { where: { name: 'faqContent6' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqContent7 || faqContent7 == '') {
        const updatefaqContent7 = await WhyHostInfoBlock.update(
          { value: faqContent7 },
          { where: { name: 'faqContent7' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
      ...
      if (faqContent8 || faqContent8 == '') {
        const updatefaqContent8 = await WhyHostInfoBlock.update(
          { value: faqContent8 },
          { where: { name: 'faqContent8' } },
        ).then(function (instance) {
          if (instance > 0) {
            isWhyHostBlockUpdated = true;
          } else {
