...
export const fileuploadDir =
  process.env.FILEUPLOAD_DIR || './src/static/images/upload/';

// Logo upload directory
export const logouploadDir =
  process.env.LOGOUPLOAD_DIR || './src/static/images/logo/';

// Home page Banner upload directory
export const banneruploadDir =
  process.env.BANNER_UPLOAD_DIR || './src/static/images/banner/';

// User Profile Photos Upload Directory
export const profilePhotouploadDir =
  process.env.PROFILE_PHOTO_UPLOAD_DIR || './src/static/images/avatar/';

//Document Upload
export const documentuploadDir =
  process.env.FILEUPLOAD_DIR || './src/static/images/document/';

// Location upload directory
export const locationuploadDir =
  process.env.LOGOUPLOAD_DIR || './src/static/images/popularLocation/';

// Static block image upload directory
export const homebanneruploadDir =
  process.env.HOME_BANNER_UPLOAD_DIR || './src/static/images/home/';

// Amenities upload directory
export const amenitiesUploadDir =
  process.env.AMENITIES_UPLOAD_DIR || './src/static/images/amenities/';

// Favicon images update directory
export const faviconUploadDir =
  process.env.FAVICON_UPLOAD_DIR || './src/static/images/favicon/';
...
export const payment = {
  ...
  stripe: {
    ...
    publishableKey:
      'pk_test_51LU8XHD2o7yzD76idnaQDMogDGCLkgcKlmPq0PrRs92c4lo1VNMbiPGEKRhE3WDLD9KhrXqN8gC9ekbMGV0sKto8003cMUgiXS',
  },
};
