...
import { Subguest } from '../../../data/models';

class SubGuestPayAmount extends React.Component {
  static propTypes = {
    content: PropTypes.shape({
      id: PropTypes.string.isRequired,
      guest: PropTypes.string.isRequired,
      subGuest: PropTypes.string.isRequired,
  ...
  render() {
    ...
    const {
      content: { id, guest, subGuest, trip, logo },
    } = this.props;
    ...
    return (
      <Layout>
        ...
        <Body textStyle={textStyle}>
          ...
          <div>
            {subGuest} has just paid his {trip}'s financial dues
          </div>
...
export default SubGuestPayAmount;
