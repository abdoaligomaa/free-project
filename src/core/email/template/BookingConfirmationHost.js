...
class BookingConfirmationHost extends React.Component {
  ...
  render() {
    ...
    const {
      content: { reservationId, threadId, logo },
    } = this.props;
    const {
      content: {
        guestName,
        ...
        <div>
              ...
              <TR>
                <TD style={textStyle}>
                  ...
                  <div>
                    ...
                    <EmptySpace height={5} />
                    <span>
                      {sitename} member since {guestJoinedYear}
                    </span>
                  </div>
          ...
          <Table width="100%">
            <TBody>
              <TR style={textStyle}>
                <TD style={space}>
                  <span style={subTitle}>Check In</span>
                  <br />
                  <EmptySpace height={10} />
                  <span>{checkInDate}</span>
                  <br />
                  <EmptySpace height={1} />
                  <span>{checkInData(allowedCheckInTime)}</span>
                </TD>
                <TD style={space}>
                  <EmptySpace height={10} />
                </TD>
                <TD style={space}>
                  <span style={subTitle}>Check Out</span>
                  <br />
                  <EmptySpace height={10} />
                  <span>{checkOutDate}</span>
                  <br />
                  <EmptySpace height={1} />
                  <span>{checkInData(allowedCheckOutTime)}</span>
                </TD>
              </TR>
              <TR style={textStyle}>
                <TD>
                  <div>
                    <span style={subTitle}>Guests</span>
                    <br />
                    <EmptySpace height={10} />
                    <span>{guests}</span>
                  </div>
                ...
                <TD>
                  <div>
                    <span style={subTitle}>Confirmation Code</span>
                    <br />
                    <EmptySpace height={10} />
