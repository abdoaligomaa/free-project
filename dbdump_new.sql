...
--
-- Host: 127.0.0.1    Database: rentall
-- ------------------------------------------------------
...
--
-- Table structure for table `Repost_Shares`
--

DROP TABLE IF EXISTS `Repost_Shares`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Repost_Shares` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `Repost_Shares`
--

LOCK TABLES `Repost_Shares` WRITE;
/*!40000 ALTER TABLE `Repost_Shares` DISABLE KEYS */;
/*!40000 ALTER TABLE `Repost_Shares` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `Reposts` (
  ...
  `start_date` varchar(255) DEFAULT NULL,
  `end_date` varchar(255) DEFAULT NULL,
  `new_night_price` float DEFAULT NULL,
...
-- Dump completed on 2022-09-11 12:45:00
