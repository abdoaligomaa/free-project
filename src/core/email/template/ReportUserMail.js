...
class ReportUserMail extends React.Component {
  ...
  render() {
    ...
    const {
      content: { userName, reporterName, reportType, logo },
    } = this.props;
    ...
    return (
      <Layout>
        ...
        <Body textStyle={textStyle}>
          ...
          <div>You got a notification for the user violation.</div>
          <EmptySpace height={20} />
          <div>
            {userName} is voilating the platform terms and reported by{' '}
            {reporterName} <br />
            <br />
