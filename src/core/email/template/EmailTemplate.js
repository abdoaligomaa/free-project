...
import SubGuestShareReservation from './SubGuestShareReservation';
...
import SubGuestPayAmount from './SubGuestPayAmount';
...
class EmailTemplate extends Component {
  ...
  render() {
    ...
    return (
      <div>
        {type === 'subGuestShareReservation' && <SubGuestShareReservation content={content} />}
        {type === 'subGuestPayAmount' && <SubGuestPayAmount content={content} />}
        ...
        {type === 'banStatusServiceStatusBanned' && (
          <BanStatusServiceStatusBanned content={content} />
        )}
        {type === 'banStatusServiceStatusUnBanned' && (
          <BanStatusServiceStatusUnBanned content={content} />
        )}
