...
const updateReservation = {
  ...
  async resolve(source,{ reservationId, actionType, threadId }, { request, response }, ccc) {
    ...
    if (request.user && !request.user.admin) {
      ...
      updateReservation?.reservationState === 'approved' && updateReservation?.couponId && cancellCrossCoupon(updateReservation.couponId);
      ...
      if (hostProfile && getThread) {
        userName =
          hostProfile && hostProfile.firstName ? hostProfile.firstName : null;
      }
      ...
      if (isReservationUpdated) {
        ...
        if (actionType === 'approved') {
          ...
          emailContent = {
            ...
            confirmationCode:
              reservationData && reservationData.confirmationCode,
          };
          await sendServerEmail(
            getThread.guest,
